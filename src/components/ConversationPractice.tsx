...
export const ConversationPractice = () => {
  ...
  useEffect(() => {
    const getVoices = () => {
      ...
      // Professional playful voice names and characteristics
      const professionalPlayfulVoices = [
        // Premium professional female voices (top priority)
        'allison', 'samantha', 'victoria', 'susan', 'karen', 'catherine', 'melissa',
        'joanna', 'kendra', 'kimberly', 'salli', 'nicole', 'amy', 'emma', 'ava',
        'ivy', 'raveena', 'aditi', 'kate', 'sara', 'fiona', 'alex', 'tessa',
        
        // Quality voice characteristics
        'enhanced', 'neural', 'premium', 'standard', 'wavenet', 'journey', 'studio',
        'polyglot', 'multilingual', 'natural', 'expressive', 'professional',
        
        // Professional but warm names
        'alice', 'anna', 'claire', 'diana', 'elena', 'eva', 'grace', 'julia',
        'laura', 'lily', 'maria', 'maya', 'nina', 'nora', 'olivia', 'sofia',
        'stella', 'vera', 'zoe', 'charlotte', 'elizabeth', 'caroline', 'sophia',
        
        // Voice quality descriptors
        'clear', 'articulate', 'confident', 'engaging', 'pleasant', 'melodic',
        'smooth', 'refined', 'polished', 'sophisticated', 'eloquent', 'crisp',
        'bright', 'conversational', 'warm', 'friendly', 'cheerful'
      ];
      ...
      const femaleVoices = voices.filter((voice) => {
        ...
        // Check for professional playful characteristics
        const isProfessionalPlayful = professionalPlayfulVoices.some(keyword => 
          name.includes(keyword)
        );
        
        // Check for basic female identifiers
        const isFemale = name.includes('female') || name.includes('woman') || 
                         name.includes('lady') || name.includes('girl');
        
        // Check for English language support
        const isEnglish = lang.includes('en');
        
        return (isProfessionalPlayful || isFemale) && isEnglish;
      });
